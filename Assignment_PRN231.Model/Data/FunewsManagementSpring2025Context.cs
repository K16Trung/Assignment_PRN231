...
namespace Assignment_PRN231.Model.Data;

public partial class FunewsManagementSpring2025Context : DbContext
{
    public FunewsManagementSpring2025Context()
    {
    }

    public FunewsManagementSpring2025Context(DbContextOptions<FunewsManagementSpring2025Context> options)
        : base(options)
    {
    }
